...
INSERT INTO students(stdid, stdname, stdlastname, stdphone, stdclass)
    VALUES(102, 'aswini', 'karimi', 234569090, '2'),
          (103, 'sowmya', 'kate', 345678, '3'),
          (104, 'lakshmi', 'somu', 345678, '4'),
          (105, 'mallika', 'boya', 345678, '5');
...
UPDATE students 
SET stdemail = 'saiamruthavanigandu@gmail.com'
WHERE stdid = 103;
